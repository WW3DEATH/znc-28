  ...
  users: [
    {
      ...
      weeklySp: 98,
      isVerified: true,
      subjectScores: { physics: 160, combined_maths: 140, chemistry: 90, ict: 60 },
      weeklyScores: { "WED-20260916": 98 },
      weeklySubjectScores: { "WED-20260916": { physics: 98, combined_maths: 0, chemistry: 0, ict: 0 } }
    },
    {
      id: "user_rizvi",
      fullName: "Ahamed Rizvi",
      email: "a.rizvi@znc.edu.lk",
      role: "STUDENT",
      stream: "Physical Science",
      spPoints: 395,
      weeklySp: 95,
      isVerified: true,
      subjectScores: { physics: 120, combined_maths: 185, chemistry: 50, ict: 40 },
      weeklyScores: { "WED-20260916": 95 },
      weeklySubjectScores: { "WED-20260916": { physics: 0, combined_maths: 95, chemistry: 0, ict: 0 } }
    },
    {
      id: "user_farhan",
      fullName: "Mohamed Farhan",
      email: "m.farhan@znc.edu.lk",
      role: "STUDENT",
      stream: "Physical Science",
      spPoints: 350,
      weeklySp: 91,
      isVerified: true,
      subjectScores: { physics: 150, combined_maths: 110, chemistry: 40, ict: 50 },
      weeklyScores: { "WED-20260916": 91 },
      weeklySubjectScores: { "WED-20260916": { physics: 91, combined_maths: 0, chemistry: 0, ict: 0 } }
    },
    {
      id: "user_nuha",
      fullName: "Fathima Nuha",
      email: "f.nuha@znc.edu.lk",
      role: "STUDENT",
      stream: "Bio Science",
      spPoints: 320,
      weeklySp: 89,
      isVerified: true,
      subjectScores: { physics: 60, combined_maths: 0, chemistry: 200, ict: 60 },
      weeklyScores: { "WED-20260916": 89 },
      weeklySubjectScores: { "WED-20260916": { physics: 0, combined_maths: 0, chemistry: 89, ict: 0 } }
    },
    {
      id: "user_salman",
      fullName: "Salman Faris",
      email: "s.faris@znc.edu.lk",
      role: "STUDENT",
      stream: "Physical Science",
      spPoints: 290,
      weeklySp: 86,
      isVerified: true,
      subjectScores: { physics: 90, combined_maths: 120, chemistry: 40, ict: 40 },
      weeklyScores: { "WED-20260916": 86 },
      weeklySubjectScores: { "WED-20260916": { physics: 0, combined_maths: 86, chemistry: 0, ict: 0 } }
    },
    {
      id: "user_aakil",
      fullName: "Mohamed Aakil",
      email: "m.aakil@znc.edu.lk",
      role: "STUDENT",
      stream: "Physical Science",
      spPoints: 275,
      weeklySp: 85,
      isVerified: true,
      subjectScores: { physics: 70, combined_maths: 50, chemistry: 40, ict: 115 },
      weeklyScores: { "WED-20260916": 85 },
      weeklySubjectScores: { "WED-20260916": { physics: 0, combined_maths: 0, chemistry: 0, ict: 85 } }
    },
    {
      id: "user_zainab",
      fullName: "Zainab Bilal",
      email: "z.bilal@znc.edu.lk",
      role: "STUDENT",
      stream: "Bio Science",
      spPoints: 245,
      weeklySp: 80,
      isVerified: true,
      subjectScores: { physics: 50, combined_maths: 0, chemistry: 155, ict: 40 },
      weeklyScores: { "WED-20260916": 80 },
      weeklySubjectScores: { "WED-20260916": { physics: 0, combined_maths: 0, chemistry: 80, ict: 0 } }
    },
    {
      id: "user_hasan",
      fullName: "Hasan Tariq",
      email: "h.tariq@znc.edu.lk",
      role: "STUDENT",
      stream: "Physical Science",
      spPoints: 220,
      weeklySp: 77,
      isVerified: true,
      subjectScores: { physics: 105, combined_maths: 75, chemistry: 20, ict: 20 },
      weeklyScores: { "WED-20260916": 77 },
      weeklySubjectScores: { "WED-20260916": { physics: 77, combined_maths: 0, chemistry: 0, ict: 0 } }
    },
    {
      id: "user_ammar",
      fullName: "Ammar Zahran",
      email: "a.zahran@znc.edu.lk",
      role: "STUDENT",
      stream: "Physical Science",
      spPoints: 200,
      weeklySp: 74,
      isVerified: true,
      subjectScores: { physics: 40, combined_maths: 50, chemistry: 30, ict: 80 },
      weeklyScores: { "WED-20260916": 74 },
      weeklySubjectScores: { "WED-20260916": { physics: 0, combined_maths: 0, chemistry: 0, ict: 74 } }
    },
    {
      id: "user_inshaf",
      fullName: "Mohamed Inshaf",
      email: "m.inshaf@znc.edu.lk",
      role: "STUDENT",
      stream: "Bio Science",
      spPoints: 180,
      weeklySp: 70,
      isVerified: true,
      subjectScores: { physics: 30, combined_maths: 0, chemistry: 120, ict: 30 },
      weeklyScores: { "WED-20260916": 70 },
      weeklySubjectScores: { "WED-20260916": { physics: 0, combined_maths: 0, chemistry: 70, ict: 0 } }
    }
  ],
...
function renderLeaderboard() {
  ...
  // Calculate scores and sort users based on selected filters
  const sorted = [...STATE.users].map(u => {
    ...
    if (subject === "overall") {
      ...
      if (timeframe === "weekly") {
        ...
        // Fallback for demo users if specific weekly not yet logged
        if (relevantScore === 0 && u.subjectScores && u.subjectScores[subject]) {
          relevantScore = Math.min(u.weeklySp || 0, u.subjectScores[subject]);
        }
      } else {
  ...
  // RESTRICT TO TOP 10 PERSONS ONLY
  const top10 = sorted.slice(0, 10);

  if (top10.length === 0 || top10.every(item => item.score === 0 && timeframe === "weekly")) {
    tbody.innerHTML = `<tr><td colspan="7" class="p-6 text-center text-xs text-slate-400 italic">No scores logged yet for this category. Complete the Wednesday examination in this subject to take the #1 spot!</td></tr>`;
    return;
  }
